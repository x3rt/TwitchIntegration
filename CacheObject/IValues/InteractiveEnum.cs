...
namespace TwitchIntegration.CacheObject.IValues
{
    public class InteractiveEnum : InteractiveValue
    {
        ...
        private void SetTogglesForValue(object value)
        {
            ...
            {
                Main.LogWarning("Exception setting flag toggles: " + ex);
            }
        }
        ...
        private void OnApplyClicked()
        {
            ...
            {
                Main.LogWarning("Exception setting from dropdown: " + ex);
            }
        }
        ...
        private void SetValueFromFlags()
        {
            ...
            {
                Main.LogWarning("Exception setting from flag toggles: " + ex);
            }
        }
