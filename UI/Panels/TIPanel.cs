...
{
    public abstract class TIPanel : PanelBase
    {
        protected TIPanel(UIBase owner) : base(owner) { }
        ...
        {
            return new TIPanelDragger(this);
        }
        ...
        public override void SetActive(bool active)
        {
            ...
            else
            {
                ...
                (this.Owner.Panels as TIPanelManager).DoInvokeOnPanelsReordered();
            }
        }
        ...
        public virtual string ToSaveData()
        {
            ...
            {
                Main.loggerInstance?.Warning($"Exception generating Panel save data: {ex}");
                return "";
            }
        }
        ...
        protected virtual void ApplySaveData(string data)
        {
            ...
            {
                Main.loggerInstance?.Warning("Invalid or corrupt panel save data! Restoring to default.");
        ...
        protected override void LateConstructUI()
        {
            ...
            {
                Main.loggerInstance?.Msg($"Exception loading panel save data: {ex}");
                SetDefaultSizeAndPosition();
            }
